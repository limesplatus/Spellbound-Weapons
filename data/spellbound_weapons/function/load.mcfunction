...
execute if data storage vanilla_refresh_config:config config{load_message:1} unless score load_message refresh_settings matches ..0 run tellraw @a [{"translate": "Successfully loaded","color": "gray"},{"translate": " Spellbound Weapons v4.1.6b","color": "green"}]
